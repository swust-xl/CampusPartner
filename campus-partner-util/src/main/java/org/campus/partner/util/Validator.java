...
public final class Validator {
    ...
    public static final class RegexType {
         ...
         * @since 1.0.0
         */
        public static final String CHINA_CELLPHONE = "^[1][0-9]\\d{9}$|^([6|9])\\d{7}$"
                + "|^[0][9]\\d{8}$|^[6]([8|6])\\d{5}$";
         ...
         * @since 1.0.3
         */
        public static final String PASSPORT_CARD = "^([a-zA-z]|[0-9]){5,21}$";
    }
    ...
    /**
     * 校验并断言表达式不为<code>false</code>.<br/>
     * 如果为<code>false</code> 则抛出{@link java.lang.RuntimeException}异常
     *
     * @param expression
     *            待校验的表达式
     ...
     * @since 1.0.4
     */
    public static void notFalse(boolean expression, RuntimeException runtimeException) {
        if (!expression) {
    ...
    /**
     * 校验并断言表达式为<code>false</code>.<br/>
     * 如果不为<code>false</code> 则抛出{@link java.lang.RuntimeException}异常
     *
     * @param expression
     *            待校验的表达式
     * @param runtimeException
    ...
    /**
     * 校验并断言表达式为<code>true</code>.<br/>
     * 如果不为<code>true</code> 则抛出{@link java.lang.RuntimeException}异常
     *
     * @param expression
     *            待校验的表达式
     * @param runtimeException
    ...
    /**
     * 校验并断言表达式不为<code>true</code>.<br/>
     * 如果为<code>true</code> 则抛出{@link java.lang.RuntimeException}异常
     *
     * @param expression
     *            待校验的表达式
     * @param runtimeException
     ...
     * @since 1.0.4
     */
    public static void notTrue(boolean expression, RuntimeException runtimeException) {
        if (expression) {
            throw runtimeException;
        }
    }
    ...
    /**
     * 校验并断言对象为<code>null</code>.<br/>
     * 如果不为<code>null</code> 则抛出{@link java.lang.RuntimeException}异常
     *
     * @param reference
     *            待校验的对象
     * @param runtimeException
     ...
     * @since 1.0.4
     */
    public static <T> void isNull(T reference, RuntimeException runtimeException) {
        if (reference != null) {
            throw runtimeException;
        }
    }
     ...
     * @since 1.0.4
     */
    public static <T> T notNull(T reference, RuntimeException runtimeException) {
        if (reference == null) {
            throw runtimeException;
        }
        return reference;
    ...
    /**
     * 校验并断言任意集合（如:List/Set）不是空. 如果是空, 则抛出{@link java.lang.RuntimeException}异常,
     * 且允许自定义错误描述信息.
     *
     * @param collection
     *            待校验的集合（如:List/Set）
     ...
     * @since 1.0.4
     */
    public static Collection<?> notEmpty(Collection<?> collection, RuntimeException runtimeException) {
        if (isEmpty(collection)) {
            throw runtimeException;
        }
        return collection;
    ...
    /**
     * 校验并断言任意Map不是空. 如果是空, 则抛出{@link java.lang.RuntimeException}异常,
     * 且允许自定义错误描述信息.
     *
     * @param map
     *            待校验的Map
     ...
     * @since 1.0.4
     */
    public static Map<?, ?> notEmpty(Map<?, ?> map, RuntimeException runtimeException) {
        if (isEmpty(map)) {
            throw runtimeException;
        }
        return map;
    ...
    /**
     * 校验并断言任意对象数组不是空. 如果是空, 则抛出{@link java.lang.RuntimeException}异常,
     * 且允许自定义错误描述信息.
     *
     * @param arr
     *            待校验的对象数组
     ...
     * @since 1.0.4
     */
    public static <T> T[] notEmpty(T[] arr, RuntimeException runtimeException) {
        if (isEmpty(arr)) {
            throw runtimeException;
        }
        return arr;
    ...
    /**
     * 校验并断言任意对象不是空. 如果是空, 则抛出{@link java.lang.IllegalArgumentException}异常
     * 
     * <pre>
     * null  false
     * ""    false
     ...
     * @since 1.0.4
     */
    public static <T> T notEmpty(T obj, Object errorMessage) {
        if (isEmpty(obj)) {
            throw new IllegalArgumentException(String.valueOf(errorMessage));
        }
        return obj;
    ...
    /**
     * 校验并断言任意对象不是空. 如果是空, 则抛出{@link java.lang.RuntimeException}异常,
     * 且允许自定义错误描述信息.
     *
     * <pre>
     * null  false
     ...
     * @since 1.0.4
     */
    public static <T> T notEmpty(T obj, RuntimeException runtimeException) {
        if (isEmpty(obj)) {
            throw runtimeException;
        }
        return obj;
     ...
     * @since 1.0.4
     */
    public static <T> T notEmpty(T obj, String errorMessageTemplate, Object... errorMessageArgs) {
        if (isEmpty(obj)) {
            throw new IllegalArgumentException(String.format(errorMessageTemplate, errorMessageArgs));
        }
        return obj;
    ...
    /**
     * 校验并断言字节型数组不是空. 如果是空, 则抛出{@link java.lang.RuntimeException}异常,
     * 且允许自定义错误描述信息.
     *
     * @param arr
     *            待校验的字节型数组
     ...
     * @since 1.0.4
     */
    public static byte[] notEmpty(byte[] arr, RuntimeException runtimeException) {
        if (isEmpty(arr)) {
            throw runtimeException;
        }
        return arr;
     ...
     * @since 1.0.4
     */
    public static int[] notEmpty(int[] arr, RuntimeException runtimeException) {
        if (isEmpty(arr)) {
            throw runtimeException;
        }
        return arr;
     ...
     * @param t
     *            任意对象
     * @return <code>true</code> 是空对象; <code>false</code> 不是空对象
     * @param <T>
     *            校验结果
     * @author xl
     * @since 1.0.4
     ...
     * 使用默认规则：{@link org.campus.partner.util.Validator.RegexType.PASSWORD}
     *
     * @param reference
     *            待校验的对象
     ...
     * 使用默认规则：{@link org.campus.partner.util.Validator.RegexType.URL}
     *
     * @param reference
     *            待校验的对象
     * @param regex
     ...
     * 使用默认规则：{@link org.campus.partner.util.Validator.RegexType.MD5}
     *
     * @param reference
     *            待校验的对象
     * @param regex
     ...
     * 使用默认规则：{@link org.campus.partner.util.Validator.RegexType.SHA1}
     *
     * @param reference
     *            待校验的对象
     ...
     * 使用默认规则：{@link org.campus.partner.util.Validator.RegexType.WSID}
     *
     * @param reference
     *            待校验的对象
     ...
     * 使用默认规则：{@link org.campus.partner.util.Validator.RegexType.BASE64}
     *
     * @param reference
     *            待校验的对象
     ...
     * 使用默认规则：{@link org.campus.partner.util.Validator.RegexType.HEX}
     *
     * @param reference
     *            待校验的对象
    ...
    /**
     * 校验任意对象是否为( <code>护照</code> )的格式.
     *
     * @param reference
     *            待校验的对象
     * @return <code>true</code> 是( <code>护照</code> )1的格式; <code>false</code>
     *         不是( <code>护照</code> )的格式
     * @param <T>
     *            校验结果
     * @author xl
     * @since 1.0.3
     */
    public static <T> boolean isPassportCard(T reference) {
        return isPassportCard(reference, RegexType.PASSPORT_CARD);
    }

    /**
     * 校验任意对象是否为( <code>护照</code> )的格式.<br/>
     * 使用默认规则：{@link org.campus.partner.util.Validator.RegexType.护照}
     *
     * @param reference
     *            待校验的对象
     * @param regex
     ...
     * @since 1.0.3
     */
    public static <T> boolean isPassportCard(T reference, String regex) {
        if (reference == null) {
            return false;
        }
        if (regex == null) {
            return isPassportCard(reference);
        }
        return match(regex, reference);
    }
